...
def get_all_users():
    ...
    # only pull what the list view actually needs, no reason to send everything
...
def create_user():
    ...
    # setting it here so users can't send in a fake timestamp
...
def update_user(user_id):
    ...
    # only allow these fields so a PUT can't overwrite _id or created_at
