...
def dashboard():
    ...
    recipes_per_category = list(db.recipes.aggregate([
        ...
        # preserveNullAndEmptyArrays keeps recipes with no category in the count
    ...
    top_rated = list(db.recipes.aggregate([
        ...
        # exclude recipes with no reviews — null avgRating would sort above real ratings
    ...
    # start from savedRecipes and count events per recipe rather than joining
    # from recipes — simpler and more direct for a pure count aggregation
